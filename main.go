...
func init() {
	...
	url := flag.String("u", "123.151.54.38:8080", "Set Url of WSClient.")
	// 默认昵称
	adana := flag.String("n", "花酱", "Set default nickname.")
	...
	// 通过代码写死的方式添加主人账号
	sus = append(sus, 2417651740)
	sus = append(sus, 2357700969)
	sus = append(sus, 3576963102)
	if *runcfg != "" {
	...
	config.Z = zero.Config{
		NickName:       append([]string{*adana}, "花酱",),
